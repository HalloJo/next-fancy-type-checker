import type { TransitionController, TransitionRef } from '../types/transition.types';
 ...
 */
export function findTransitionController(ref: TransitionRef): TransitionController | undefined {
